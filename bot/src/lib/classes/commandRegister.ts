...
import { MscvCommandObject, MscvSubcommandGroupObject, MscvCommandOptionObject, MscvSubcommandObject } from '../../shared/types/commands';
...
export class CommandRegister {
    ...
    constructor(MscvCommandObject: MscvCommandObject) {
        this.cmdObj = MscvCommandObject;
    }
    ...
    private addOption(builder: SlashCommandBuilder | SlashCommandSubcommandBuilder, option: MscvCommandOptionObject): void {
        let opt;
    ...
    private addSubcommand = (builder: SlashCommandBuilder | SlashCommandSubcommandGroupBuilder, subcommand: MscvSubcommandObject) => {
    ...
    private addSubcommandGroup = (builder: SlashCommandBuilder, subcommandgroup: MscvSubcommandGroupObject) => {
